"""Booking Page Locators support module for Yandex Praktikum Automation QA projects: Sprint 6 Page Object / Locators."""
...
class BookingPageLocators:
    ...
    color_choice_field = (
        By.XPATH,
        './/div[@class="Order_Title__3EKne" and text() = "Цвет самоката"]',
    )
