"""Locators module for Yandex Praktikum Automation QA projects: Diploma Project / Diplom 3."""
...
class AccountPageLocators:
    ...
    ORDER_NUMBER_IN_ORDER_HISTORY = (
        By.XPATH,
        '//*[contains(@class,"textBox")]//p[contains(@class,"digits-default")]',
    )
...
class ConstructorPageLocators:
    ...
    INGREDIENT_COUNTER = (
        By.XPATH,
        '//*[@href="/ingredient/61c0c5a71d1f82001bdaaa6c"]//p[contains(@class, "counter__num")]',
    )
