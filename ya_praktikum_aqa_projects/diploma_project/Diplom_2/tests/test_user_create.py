"""Automated test cases for User Create in Yandex Praktikum Automation QA projects: Diploma Project / Diplom 2."""
...
class TestUserCreate:
    ...
    def test_user_create_unique_true(self, gen_email, gen_pass, gen_name, delete_user):
        payload = {"email": gen_email, "password": gen_pass, "name": gen_name}
